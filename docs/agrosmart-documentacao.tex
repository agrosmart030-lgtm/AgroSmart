...
Para evitar consumo excessivo do plano gratuito do Supabase, o backend limita o histórico de cotações a uma entrada diária por provedor, grão e local. A rotina também aplica retenção configurável por \texttt{COTACOES\_HISTORY\_RETENTION\_DAYS} e teto de linhas por \texttt{COTACOES\_HISTORY\_MAX\_ROWS}.
